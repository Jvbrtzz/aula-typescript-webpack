/******/ (() => {
  ...
  \********************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const validator_1 = __webpack_require__(/*! ./validator */ "./src/components/validator.ts");
        const http_1 = __webpack_require__(/*! ../components/http/http */ "./src/components/http/http.ts");
          ...
          if (form) {
            ...
            form.addEventListener("submit", async (event) => {
              ...
              writeUserData(
                formData.nome,
                formData.email,
                formData.mensagem ? formData.mensagem[0] : "",
                formData.cep,
                rua,
              );
              (0, validator_1.validateForm)(formData);
        ...
        function writeUserData(nome, email, message, cep, rua) {
          if (nome && email && message && cep) {
            const nomeItem = document.querySelector("#user-name");
            const emailItem = document.querySelector("#user-email");
            const messageItem = document.querySelector("#user-message");
            const cepItem = document.querySelector("#user-cep");
            const ruaItem = document.querySelector("#user-rua");
